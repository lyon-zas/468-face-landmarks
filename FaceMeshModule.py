...
class FaceMeshDetection():
    def __init__(self, staticMode = False, maxFaces=2,minDetectionCon= 0.5,MinTrackerCon= 0.5):
        ...
        self.faceMesh = self.mpFaceMesh.FaceMesh(self.staticMode,self.maxFaces, self.minDetectionCon, self.MinTrackerCon)
